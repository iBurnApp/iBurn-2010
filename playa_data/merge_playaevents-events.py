...
unmatched_events_file = codecs.open('./results/unmatched_events.json', 'w', "utf-8")
json_content = json.dumps(unmatched_events, sort_keys=True, indent=4)
json_stripped = json_content.strip(codecs.BOM_UTF8)
json_stripped_cleaned = convert_html_entities(json_stripped)
unmatched_events_file.write(json_stripped_cleaned)

result_file = codecs.open('./results/event_data_and_locations.json', 'w', "utf-8")
json_content = json.dumps(events_json, sort_keys=True, indent=4)
json_stripped = json_content.strip(codecs.BOM_UTF8)
json_stripped_cleaned = convert_html_entities(json_stripped)
