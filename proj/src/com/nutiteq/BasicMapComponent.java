...
//      screenBufferGraphics = screenBuffer.getGraphics();
  ...
  protected boolean paintTile(final Graphics g, final MapTile mt, final MapPos centerCopy,
    ...
    if (pos >= 0
        ...
        final int left = mt.getX() - centerCopy.getX() + displayCenterX;
        final int top = mt.getY() - centerCopy.getY() + displayCenterY;
        g.setClip(left, top, displayedMap.getTileSize(), displayedMap.getTileSize());
        g.setColor(0xFFFFFFFF);
        g.fillRect(left, top, displayedMap.getTileSize(), displayedMap.getTileSize());
 ...
 */
    ...
    public void pointerDraggedDual() {
